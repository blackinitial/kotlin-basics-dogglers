...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.itemImage?.setImageResource(dogData.imageResourceId)

        // TODO: Set the text for the current dog's name
        holder.itemName?.text = dogData.name

        // TODO: Set the text for the current dog's age
        val resources = context?.resources
        holder.itemAge?.text = resources?.getString(R.string.dog_age, dogData.age)

        // TODO: Set the text for the current dog's hobbies by passing the hobbies to the
        //  R.string.dog_hobbies string constant.
        //  Passing an argument to the string resource looks like:
        //  resources?.getString(R.string.dog_hobbies, dog.hobbies)
        holder.itemHobbies?.text = resources?.getString(R.string.dog_hobbies, dogData.hobbies)
    }
}
